        ...
        <div className="checkout-ProductDetail ">
          <div className="checkout-body-ProductDetail">
            <div className="ProductDetail-left">
              <div className="grid grid-cols-12 gap-4 details-SLider">
                <div className="col-span-12 relative">
                  <div className="hotel_details_slider">
                    ...
                    >
                      <img
                        className="larger-slide-image object-cover"
                        src={main_product}
                        alt=""
                      />
                      <img
                ...
                <div className="col-span-12 w-79 ">
                  <div className="hotel_item">
                    ...
                    >
                      <img
                        className="smaller-slide-image object-cover"
                        src={main_product}
                        alt=""
                      />
                      <img
